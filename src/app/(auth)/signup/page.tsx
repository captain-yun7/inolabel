...
export default function SignupPage() {
  ...
  // 폼 값들
  const { fullName, nickname, email, soopId, password, confirmPassword } = form.values;
          ...
          <Stack gap="md">
            ...
            <Box>
              <TextInput
                ...
                rightSection={
                  fullName.length > 0 && !form.errors.fullName
                    ? renderValidIcon(fullNameValid)
                    : null
                }
