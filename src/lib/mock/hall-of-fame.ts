    ...
    top3: [
      {
        ...
        memberVideos: [
          ...
          { id: 'mv-3', memberName: '스타부장', memberUnit: 'crew', message: '다음 시즌에도 함께해요!' },
        ],
        exclusiveSignatures: [
          { id: 'sig-1', memberName: 'RG대표' },
          { id: 'sig-2', memberName: '엑셀부장' },
          { id: 'sig-3', memberName: '스타부장' },
      ...
      },
      {
        ...
        memberVideos: [
          ...
          { id: 'mv-5', memberName: '스타부장', memberUnit: 'crew', message: '스타부 최고 서포터!' },
        ],
        exclusiveSignatures: [
          { id: 'sig-5', memberName: 'RG대표' },
          { id: 'sig-6', memberName: '스타부장' },
        ],
        createdAt: '2024-12-31T23:59:59Z',
      },
      {
