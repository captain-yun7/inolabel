    ...
    Tables: {
      profiles: {
        Row: {
          ...
          soop_id: string | null // 숲TV 아이디
          pandatv_id: string | null // PandaTV 플랫폼 아이디 (레거시)
      ...
      starcraft_tier_members: {
        ...
        Relationships: [
          {
            foreignKeyName: 'starcraft_tier_members_tier_id_fkey'
            columns: ['tier_id']
            referencedRelation: 'starcraft_tiers'
            referencedColumns: ['id']
          }
        ]
      }
...
export interface StarcraftTier {
  id: number
  name: string
  display_order: number
  color: string | null
...
export interface StarcraftTierMember {
  id: number
  tier_id: number
  player_name: string
...
export interface StarcraftTierWithMembers extends StarcraftTier {
  members: StarcraftTierMember[]
}
